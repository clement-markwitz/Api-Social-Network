...
public class Message {
     ...
     */
    @Indexed // Index VITAL pour récupérer les messages d'une conversation
    private String conversationId; // Remplace votre "convId"
    ...
    private String senderId; // Renommé "fromId" pour plus de clarté
